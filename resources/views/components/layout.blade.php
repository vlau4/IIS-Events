...
<body class="mb-48">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.1.1/flowbite.min.js"></script>
        ...
        @auth
            ...
            <button id="createButton" data-dropdown-toggle="create" data-dropdown-trigger="hover" class=" text-white bg-sky-900 hover:bg-sky-700 focus:outline-none font-medium rounded-lg px-8 mx-8 py-2.5 text-center inline-flex items-center dark:bg-sky-900 dark:hover:bg-sky-700" type="button">Create <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                ...
                {{-- CONFIRM --}}
                <ul>
                    <li class=" text-white bg-sky-900 hover:bg-sky-700 focus:outline-none font-medium rounded-lg px-8 mx-8 py-2.5 text-center inline-flex items-center dark:bg-sky-900 dark:hover:bg-sky-700">
                ...
                @else
                    <ul class="py-2  text-gray-700 dark:text-gray-200" aria-labelledby="manageButton">
                        <li class="text-white bg-sky-900 hover:bg-sky-700 font-medium rounded-lg  px-8 mx-8 py-2.5 text-center inline-flex items-center dark:bg-sky-900 dark:hover:bg-sky-700">
    ...
    <footer class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-sky-900 text-white h-24 mt-24 opacity-90 md:justify-center">
        ...
        <a href="{{ Route('event.create') }}" class="absolute top-1/3 right-10 bg-black text-white py-2 px-8 mx-8">Post Event</a>
    </footer>
